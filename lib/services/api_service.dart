...
class ApiService {
  ...
  Future<String> _getRequest(String endpoint) async {
    ...
    final response = await client.get(Uri.parse(fullUrl),headers: {HttpHeaders.authorizationHeader: 'Bearer $jwtToken'});
  ...
  Future<String> getRestaurantInfo() async => await _getRequest('settings/restaurant/1/');
}