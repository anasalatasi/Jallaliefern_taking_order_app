...
class PreorderPage extends StatefulWidget {
  @override
  _PreorderPage createState() => _PreorderPage();
}

class _PreorderPage extends State<PreorderPage> with WidgetsBindingObserver {
  ...
  Future<void> _onRefresh() async {
    ...
    try {
      final tmp = await locator<ApiService>().getPreOrders();
      setState(() {
        orders = tmp;
      });
